...
**Последнее обновление:** 2026-05-24 (Добавлен LFL анализ с модальным окном детализации, улучшен UI админ-панели: зелёные чекбоксы, убран скролл списков прав, исправлен клик по строкам, уникальные ID чекбоксов)  
**Версия:** 2.5.4  
