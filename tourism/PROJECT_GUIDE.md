...
**Версия:** 2.1 (с RBAC системой прав и корректным часовым поясом)  
...
**Последнее обновление:** 2026-05-23 (Исправлено отображение времени по часовому поясу сервера MSK)  
**Версия:** 2.1  
